...
let dummyRecipe: Recipe = Recipe(
    name: "Crème Brulee",
    author: "Rene Du Toit",
    description: "It is a classic French dessert that consists of a rich and creamy custard base, typically flavored with vanilla, and a crisp caramelized sugar crust on top.",
